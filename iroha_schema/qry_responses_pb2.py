...
import iroha_schema.block_pb2 as block__pb2
import iroha_schema.transaction_pb2 as transaction__pb2
import iroha_schema.primitive_pb2 as primitive__pb2
...
_QUERYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='query_hash', full_name='iroha.protocol.QueryResponse.query_hash', index=9,
